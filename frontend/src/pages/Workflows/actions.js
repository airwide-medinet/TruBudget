...
export const WORKFLOWS_STORE_HISTORY_SEARCH_NAME = "WORKFLOWS_STORE_HISTORY_SEARCH_NAME";
...
export function storeWorkflowsPermissionSelected(selectedPermission) {
  return {
    type: WORKFLOWS_STORE_SELECTED_PERMISSION,
    selectedPermission
  };
}

export function storeWorkflowSearchHistoryStartDate(searchHistoryStartDate) {
  return {
...
export function storeWorkflowSearchHistoryName(searchHistoryName) {
  return {
    type: WORKFLOWS_STORE_HISTORY_SEARCH_NAME,
    searchHistoryName
  };
}
